...
class ConversationModel {
  ...
  ConversationModel.toConversation(Map<String, dynamic> conversationUser, ChatMessageModel message) {
  ...
  List<String> getColumns() {
    return ["conversationId", "userId", "chatUserId", "trueName", "lastContent", "lastContentType", "onLineStatus", "lastContentTime", "isLastSendSuccess"];
  }
}
