...
class ChatMessageModel {
  ...
  ChatMessageModel.toOwnMessage(int msgType, String msgContent, {int mediaDuration = 0}) {
  ...
  ChatMessageModel.toMessage(Map<String, dynamic> message) {
    ...
    DateFormat dateFormat = DateFormat("yyyy-MM-dd HH:mm:ss${receivedTime.length == 21 ? '.SSS' : ''}");
