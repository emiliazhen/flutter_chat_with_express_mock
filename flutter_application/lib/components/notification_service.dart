...
class NotificationService {
  ...
  void _selectNotification(NotificationResponse details) async {
    ...
    Navigator.of(myGlobals.scaffoldKey!.currentContext!).pushNamedAndRemoveUntil('/', (Route<dynamic> route) => false, arguments: {'index': 2});
  }

  // 显示通知
  Future<void> showNotifications(int sourceId, String title, String text, String messageId) async {
