...
import 'package:flutter_application/components/base_loading.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:path_provider/path_provider.dart';

class ChatVideoViewPage extends StatefulWidget {
  const ChatVideoViewPage({Key? key, required this.videoUrl, required this.videoDuration}) : super(key: key);
...
class _ChatVideoViewPageState extends State<ChatVideoViewPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.network('${Config.fileDomain}${widget.videoUrl}')
      ..initialize().then((_) {
          ...
          child: Container(
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                Offstage(
                  offstage: _controller == null ? true : _controller.value.isPlaying,
                  child: GestureDetector(
                    onTap: _controlPlay,
                    child: Icon(
                ...
                Positioned(
                  ...
                  child: Offstage(
                    ...
                    child: GestureDetector(
                      onTap: _closeVideo,
                      child: Container(
                        decoration: BoxDecoration(color: Color(0xff666666), borderRadius: BorderRadius.all(Radius.circular(10.w))),
                        width: 60.w,
                        height: 60.w,
                        child: Icon(
                          Icons.close,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            durationFormat(Duration(milliseconds: _position).inSeconds),
                          ...
                          SizedBox(
                            ...
                            child: LinearProgressIndicator(
                              value: _position / (widget.videoDuration * 1000).toDouble(),
