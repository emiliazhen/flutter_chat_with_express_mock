...
import 'package:flutter_application/components/base_button.dart';
import 'package:flutter_application/components/base_picker_select.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _selectUserTap() async {
    ...
    if (Provider.of<UserListProvide>(context, listen: false).userCount == 0) {
      ...
      if (res.data['code'] == 200) {
        Provider.of<UserListProvide>(context, listen: false).setUserList(res.data['data']);
        _userListDialog();
      }
    } else {
  ...
  void _userListDialog() {
    showDialog(
        context: context,
        builder: (context) => Consumer<UserListProvide>(builder: (_, userList, child) {
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
            gradient: LinearGradient(colors: [Color.fromARGB(255, 228, 229, 231), Color.fromARGB(255, 199, 232, 252)], begin: Alignment.bottomLeft, end: Alignment.topRight)),
        width: 1.sw,
        height: 1.sh,
        child: Column(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'HR Flutter App',
                      style: TextStyle(color: Colors.blue.shade300, fontSize: 38.sp, fontWeight: FontWeight.bold),
                    ),
                  )
                ],
              ),
