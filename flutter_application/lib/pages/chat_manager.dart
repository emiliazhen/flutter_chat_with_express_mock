...
import 'package:flutter_application/pages/member_manager.dart';
...
import 'package:flutter_application/pages/chat_detail.dart';
...
class _ChatManagerPageState extends State<ChatManagerPage> {
    ...
    return Scaffold(
      appBar: setCustomAppBar(context, '',
          ...
          actions: [
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => MemberMangerPage()));
              },
              child: Container(
            ...
            CustomPopupMenu(
              ...
              menuBuilder: () => Container(
                  decoration: BoxDecoration(color: Color(0xFF4C4C4C), borderRadius: BorderRadius.circular(10.sp)),
                  child: IntrinsicWidth(
                    ...
                    _popItem('消息测试', Icons.message, () {
                      ...
                      if (_isTestChat) {
                        ...
                        Provider.of<WebSocketProvide>(context, listen: false).openTestChat(context);
                      } else {
                        UtilDialog.showMessage(context, '关闭测试！');
                        Provider.of<WebSocketProvide>(context, listen: false).closeTestChat(context);
                      }
        ...
        return Column(children: [
          ...
          Expanded(
              child: SlidableAutoCloseBehavior(
                  child: ListView(
            children: conversation.conversations.map((item) => _conversationItem(item)).toList(),
          )))
        ]);
      }),
    );
  ...
  // 气泡选项
  Widget _popItem(String text, IconData iconData, VoidCallback onTap) => GestureDetector(
        onTap: onTap,
        child: Container(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Container(
                child: Text(
                  "重试",
                  style: TextStyle(color: const Color(0xff2294E2), fontSize: 26.sp),
                ),
              ),
            )
          ],
    ...
    return Slidable(
        ...
        endActionPane: ActionPane(
          ...
          children: [
            SlidableAction(
              onPressed: (_) {
                Provider.of<ConversationProvide>(context, listen: false).delConversation(context, conversation);
              },
        ...
        child: InkWell(
            ...
            child: Container(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: Colors.white, border: Border(bottom: BorderSide(width: 1.h, color: Color(0xffefefef)))),
                  child: Row(
                    children: [
                      Stack(clipBehavior: Clip.none, children: <Widget>[
                        CircleAvatar(
                          radius: 45.h,
                          child: Text(
                            conversation.trueName.isEmpty ? '-' : conversation.trueName.substring(0, 1),
  ...
  // 消息群聊会话
  Widget _groupConversationItem(String userName, String message) => GestureDetector(
        onTap: () {
          // todo:
          // Navigator.push(
          //     context,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 80.h,
                  width: 80.h,
                  decoration: BoxDecoration(color: Colors.blue, borderRadius: BorderRadius.all(Radius.circular(10.sp))),
                  child: Wrap(
                    children: [
                      Icon(
                        Icons.person,
                ...
                Expanded(
                    child: Container(
                  height: 80.h,
                  decoration: BoxDecoration(border: Border(bottom: BorderSide(width: 2.h, color: Color(0xffdddddd)))),
          ...
          Row(
            ...
            children: <Widget>[
              conversation.isLastSendSuccess == chatLogStatusEnum["Failed"]
                  ...
                  : conversation.isLastSendSuccess == chatLogStatusEnum["Sending"]
                      ? Container(
                          margin: EdgeInsets.only(right: 10.w),
                          height: 26.h,
                          width: 26.h,
                      ...
                      : Container(),
              Expanded(
                child: Text(_showLastContent(conversation), maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Color(0xffa0a0a0), fontSize: 24.sp)),
              )
            ],
          ),
        ],
