        ...
        children: [
          Container(
              ...
              child: ClipPath(
                ...
                child: Container(
                    decoration:
                        const BoxDecoration(gradient: LinearGradient(colors: [Color(0xFF0074ff), Color(0xFF019cfe)], begin: Alignment.bottomCenter, end: Alignment.topCenter)),
                    width: 1.sw,
                    height: 350.h,
                    child: Container(
                      margin: EdgeInsets.symmetric(horizontal: 35.w, vertical: 70.h),
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 35.w),
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(20.sp)), boxShadow: [
                    BoxShadow(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 16, color: Color(0xff333333), fontWeight: FontWeight.bold),
                              ),
                            ),
                            RichText(
                              text: TextSpan(text: 'ID：', style: TextStyle(fontSize: 24.sp, color: Color(0xff999999)), children: [
                                TextSpan(
                                  text: SharedPreferencesUtil.userInfo['userId'].toString(),
                                )
                              ]),
                            )
                          ],
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      title,
                      style: TextStyle(fontSize: 26.sp, color: const Color(0xFF0a1c32)),
                    ),
                  )
                ],
              ),
