...
import 'package:flutter_application/components/base_toast.dart';
...
class UtilDialog {
      ...
      builder: (BuildContext context) {
        return Center(
          child: Container(
            ...
            decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(15.sp))),
            child: Container(
              ...
              child: Column(
                ...
                children: actions.map((res) {
                  return Container(
                    ...
                    decoration: actions.last == res ? null : BoxDecoration(border: BorderDirectional(bottom: BorderSide(width: 1.h, color: Color(0xFFeeeeee)))),
                    child: res,
                  );
                }).toList(),
              ),
  ...
  /// 确认框
  static void showConfirm(BuildContext context, {String content = '', Function? callback, String title = '提示', Widget? widget, showBtn = true}) {
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
