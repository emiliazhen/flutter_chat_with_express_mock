...
class ProvideGlobal {
  ...
  ProvideGlobal() {
    _providers.add(ChangeNotifierProvider<ChatMessageProvide>(create: (ctx) => _chatMessageProvide));
    _providers.add(ChangeNotifierProvider<ConversationProvide>(create: (ctx) => _conversationProvide));
    _providers.add(ChangeNotifierProvider<WebSocketProvide>(create: (ctx) => _webSocketProvide));
    _providers.add(ChangeNotifierProvider<ChatSoundProvide>(create: (ctx) => _chatSoundProvide));
    _providers.add(ChangeNotifierProvider<UserListProvide>(create: (ctx) => _userListProvide));
  }
